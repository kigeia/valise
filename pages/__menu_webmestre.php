...
<ul id="treeview">
	<li>Accueil &amp; Informations
		<ul>
			...
			<li class="webmestre_identite_installation"><a href="./index.php?page=webmestre_identite_installation">Identité de l\'installation</a></li>
			<li class="webmestre_maintenance"><a href="./index.php?page=webmestre_maintenance">Maintenance &amp; mise à jour</a></li>
			</ul>
	</li>
';
if(HEBERGEUR_INSTALLATION=='multi-structures')
{
	...
	<li>Gestion des établissements
		<ul>
			<li class="webmestre_geographie"><a href="./index.php?page=webmestre_geographie">Zones géographiques</a></li>
			<li class="webmestre_structure"><a href="./index.php?page=webmestre_structure">Établissements</a></li>
			<li class="webmestre_statistiques"><a href="./index.php?page=webmestre_statistiques">Statistiques d\'utilisation</a></li>
			<li class="webmestre_newsletter"><a href="./index.php?page=webmestre_newsletter">Lettre d\'information</a></li>
		</ul>
	</li>
	';
}
elseif(HEBERGEUR_INSTALLATION=='mono-structure')
{
	...
	<li>Gestion de l\'établissement
		<ul>
			<li class="webmestre_statistiques"><a href="./index.php?page=webmestre_statistiques">Statistiques d\'utilisation</a></li>
			<li class="webmestre_mdp_admin"><a href="./index.php?page=webbmestre_mdp_admin">Mot de passe administrateur</a></li>
			<li class="webmestre_resilier"><a href="./index.php?page=webmestre_resilier">Résilier l\'inscription</a></li>
		</ul>
	</li>
	';
}

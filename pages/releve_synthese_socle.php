...
<form action="#" method="post" id="form_select"><fieldset>
	...
	<span class="tab"></span><button id="bouton_valider" type="submit" class="hide" class="generer">Générer.</button><label id="ajax_msg">&nbsp;</label><br />
</fieldset></form>

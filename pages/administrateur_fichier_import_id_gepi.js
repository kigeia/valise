		...
		(
			function()
			{
				...
				(
					{
						type : 'POST',
						url : 'ajax.php?page='+PAGE+'&action='+f_action,
						dataType : "html",
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		('#import_gepi_eleves',
			{
				action: 'ajax.php?page='+PAGE+'&action=import_gepi_eleves',
				name: 'userfile',
				data: {},
				autoSubmit: true,
				responseType: "html",
		...
		('#import_gepi_profs',
			{
				action: 'ajax.php?page='+PAGE+'&action=import_gepi_profs',
				name: 'userfile',
				data: {},
				autoSubmit: true,
				responseType: "html",
		...
		function verifier_fichier(fichier_nom,fichier_extension)
		{
			...
			else if (fichier_extension.toLowerCase()!='csv')
			{

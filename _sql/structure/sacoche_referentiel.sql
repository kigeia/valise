...
CREATE TABLE sacoche_referentiel (
	...
	referentiel_calcul_methode ENUM("geometrique","arithmetique","classique") COLLATE utf8_unicode_ci NOT NULL DEFAULT "geometrique" COMMENT "Coefficients en progression géométrique, arithmetique, ou moyenne classique non pondérée. Valeur surclassant la configuration par défaut.",

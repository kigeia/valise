/**
 * @version $Id: eval_select.js 8 2009-10-30 20:56:02Z thomas $
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		var modifier = function()
		{
			...
			nombre_eleve  = $(this).parent().prev().prev().prev().html();
			liste_eleve   = $(this).parent().prev().prev().prev().attr('lang');
			info          = $(this).parent().prev().prev().html();
			nombre_compet = $(this).parent().prev().html();
			liste_compet  = $(this).parent().prev().attr('lang');
			...
			if(liste.length)
			{
				...
				for(i in tab_id)
				{
					...
					if($('input[id^='+id+']').length)
					{
						...
						$('input[id^='+id+']').parent().parent().css("display","block");	// le regroupement
					}
				}
			}
		};
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
//	Clic sur le lien pour fermer le cadre des élèves associés à une évaluation (annuler / retour)
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		$('a.annuler_eleve').click
		(
			function()
			{
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
//	Clic sur le lien pour valider le choix des élèves associés à une évaluation
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		$('a.valider_eleve').click
		(
			function()
			{
				var liste = '';
		...
		function retour_form_valide(responseHTML)
		{
			...
			else
			{
				...
				switch (action)
				{
					case 'ajouter':
					case 'dupliquer':
						new_tr  = '<tr class="new">'+responseHTML+'</tr>';

...
if($action=='ajouter')
{
	...
	{
		foreach($tab_select_classes as $groupe_id)
		{
...
// Affichage du bilan des affectations des professeurs dans les classes ; en deux requêtes pour récupérer les professeurs sans classes et les classes sans professeurs
...
// Récupérer la liste des professeurs / classes

...
<ul class="puce">
	...
	<li><span class="manuel"><a class="pop_up" href="<?php echo SERVEUR_DOCUMENTAIRE ?>?fichier=environnement_generalites__fonctionnalites_professeur">DOC : Fonctionnalités pour un professeur.</a></span></li>
</ul>

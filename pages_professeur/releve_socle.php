...
$select_palier      = afficher_select(paliers_etabl()         , $select_nom='f_palier'      , $option_first='non' , $selection=false , $optgroup='non');
$select_groupe      = afficher_select(groupes_professeur()    , $select_nom='f_groupe'      , $option_first='val' , $selection=false , $optgroup='oui');
?>

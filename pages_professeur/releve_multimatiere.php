...
$tab_classes_prof_prin = DB_STRUCTURE_OPT_classes_prof_principal($_SESSION['USER_ID']);
$tab_periodes_etabl    = DB_STRUCTURE_OPT_periodes_etabl();
$select_groupe         = afficher_select($tab_classes_prof_prin  , $select_nom='f_groupe'      , $option_first='oui' , $selection=false                        , $optgroup='non');

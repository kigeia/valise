...
$tab_matieres_etabl  = DB_STRUCTURE_OPT_matieres_etabl($_SESSION['MATIERES'],$transversal=true);
$tab_niveaux_etabl   = DB_STRUCTURE_OPT_niveaux_etabl($_SESSION['NIVEAUX'],$_SESSION['PALIERS']);
$tab_classes_groupes = DB_STRUCTURE_OPT_classes_groupes_etabl();
$select_matiere      = afficher_select($tab_matieres_etabl     , $select_nom='f_matiere'     , $option_first='oui' , $selection=false                        , $optgroup='non');
$select_niveau       = afficher_select($tab_niveaux_etabl      , $select_nom='f_niveau'      , $option_first='oui' , $selection=false                        , $optgroup='non');
$select_groupe       = afficher_select($tab_classes_groupes    , $select_nom='f_groupe'      , $option_first='val' , $selection=false                        , $optgroup='oui');

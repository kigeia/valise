		...
		<tr>
			<td class="nu">
				<p id="p_eleves" class="hide">
					<b>Élèves au statut désactivé :</b> <img alt="" src="./_img/bulle_aide.png" title="Utiliser la touche <i>Shift</i> pour une sélection multiple contiguë.<br />Utiliser la touche <i>Ctrl</i> pour une sélection multiple non contiguë." /><br />
				...
				<p id="p_professeurs_directeurs" class="hide">
					<b>Professeurs / Directeurs au statut désactivé :</b> <img alt="" src="./_img/bulle_aide.png" title="Utiliser la touche <i>Shift</i> pour une sélection multiple contiguë.<br />Utiliser la touche <i>Ctrl</i> pour une sélection multiple non contiguë." /><br />

<?php
/**
 * @version $Id: password.ajax.php 8 2009-10-30 20:56:02Z thomas $
...
{
	echo changer_son_mdp($_SESSION['STRUCTURE_ID'],$_SESSION['USER_ID'],$_SESSION['PROFIL'],$password_ancien,$password_nouveau);
}

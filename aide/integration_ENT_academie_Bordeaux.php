<?php
/**
 * @version $Id: integration_ENT_academie_Bordeaux.php 8 2009-10-30 20:56:02Z thomas $
...
$TITRE = "Intégration ENT académie Bordeaux";
?>

<h2>Introduction</h2>
<p>
	Si un établissement est inscrit à l'ENT <em>Argos</em> mis en place sur l'académie de <em>Bordeaux</em>, les utilisateurs peuvent se connecter à <em>SACoche</em> en SSO avec leurs identifiants de l'ENT.
</p>
...
<p>
	...
	En administrateur de <em>SACoche</em>, il faut passer par le menu <em>[Paramétrages]</em> puis <em>[Mode d'identification]</em>, cocher le bon bouton et valider.
</p>

<h2>Importer l'identifiant de l'ENT</h2>
<p>
	Lorsque l'utilisateur est connecté à l'ENT, le serveur d'authentification revoie un identifiant (pour <em>Argos</em> il s'agit du login). <em>SACoche</em> doit le connaître pour établir la liaison.
</p>
<ul class="puce">
	<li>Récupérer le fichier «&nbsp;mdp_argos_<i>uai_date_num</i>.csv&nbsp;» envoyé à l'administrateur d'<em>Argos</em> après qu'il ait importé les utilisateurs dans <em>Sarapis</em>. Ce fichier contient les colonnes suivantes :</li>
</ul>
<table>
	<tbody>
		<tr><th>rne</th><th>login</th><th>mdp</th><th>nom</th><th>prenom</th><th>categorie</th><th>discipline</th><th>classe</th></tr>
	</tbody>
</table>
<p />
<ul class="puce">

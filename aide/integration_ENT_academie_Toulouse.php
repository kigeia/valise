<?php
/**
 * @version $Id: integration_ENT_academie_Toulouse.php 8 2009-10-30 20:56:02Z thomas $
...
$TITRE = "Intégration ENT académie Toulouse";
?>

<h2>Introduction</h2>
<p>
	Si un établissement est inscrit à l'ENT <em>K-d'école</em> mis en place sur l'académie de <em>Toulouse</em>, les utilisateurs peuvent se connecter à <em>SACoche</em> en SSO avec leurs identifiants de l'ENT.
</p>
...
<p>
	...
	<ul class="puce">
		...
		<li>En administrateur de <em>K-d'école</em>, il faut ajouter dans la gestion du Portail de l'ENT un service avec comme type de SSO <em>[SSO standard]</em>.</li>
	</ul>
</p>

<h2>Importer l'identifiant de l'ENT</h2>
<p>
	Lorsque l'utilisateur est connecté à l'ENT, le serveur d'authentification revoie un identifiant (pour <em>K-d'école</em> il s'agit numéro interne "uid"). <em>SACoche</em> doit le connaître pour établir la liaison.
</p>
<ul class="puce">
	<li>En administrateur de <em>K-d'école</em>, récupérer le fichier au format csv contenant les colonnes suivantes :</li>
</ul>
<table>
	<tbody>

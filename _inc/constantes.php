...
define('VERSION_BASE','2012-02-15');
...
define('ID_MATIERE_TRANSVERSALE'  ,9999);          // id de la matière transversale dans la table "sacoche_matiere" ; les id des matières spécifiques sont supérieurs

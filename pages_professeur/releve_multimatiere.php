...
$select_groupe      = afficher_select(classes_prof_principal() , $select_nom='f_groupe'      , $option_first='oui' , $selection=false                        , $optgroup='non');
$select_periode     = afficher_select(periodes_etabl()         , $select_nom='f_periode'     , $option_first='val' , $selection=false                        , $optgroup='non');
...
<form id="form_select" action=""><fieldset>
	...
	<label class="tab" for="f_opt_bilan">Opt. relevé <img alt="" src="./_img/bulle_aide.png" title="Deux lignes de synthèse peuvent être ajoutées.<br />Dans ce cas, une note sur 20 peut aussi être affichée." /> :</label><label for="f_bilan_ms"><input type="checkbox" id="f_bilan_ms" name="f_bilan_ms" value="1" checked="checked" /> Moyenne des scores</label>&nbsp;&nbsp;&nbsp;<label for="f_bilan_pv"><input type="checkbox" id="f_bilan_pv" name="f_bilan_pv" value="1" checked="checked" /> Pourcentage d'acquisitions validées</label>&nbsp;&nbsp;&nbsp;<label for="f_conv_sur20"><input type="checkbox" id="f_conv_sur20" name="f_conv_sur20" value="1" /> Proposition de note sur 20</label><p />

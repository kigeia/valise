...
<form action="" id="form1">
	...
	<div id="zone_actions" class="hide">
		<h2>Avec les demandes cochées :</h2>
		<fieldset>
			<label class="tab" for="f_creer">Action :</label>
			<select id="f_quoi" name="f_quoi">
				<option value=""></option>
				<option value="creer">Créer une nouvelle évaluation.</option>
				<option value="completer">Compléter une évaluation existante.</option>
				<option value="changer">Changer le statut pour "en préparation".</option>
				<option value="retirer">Retirer de la liste des demandes.</option>
			</select>
		</fieldset>
		<fieldset id="step_qui" class="hide">
			<label class="tab" for="f_comment">Élève(s) :</label>
			<select id="f_qui" name="f_qui">
				<option value="groupe"></option>
				<option value="select">Élèves sélectionnés</option>
			</select>
		</fieldset>
		...
		<fieldset id="step_suite" class="hide">
			<label class="tab" for="f_creer">Suite :</label>
			<select id="f_suite" name="f_suite">
				<option value="changer">Changer ensuite le statut pour "en préparation".</option>
				<option value="retirer">Retirer ensuite de la liste des demandes.</option>
			</select>
		</fieldset>
		<p id="step_valider" class="hide">
			<span class="tab"></span><input type="hidden" name="f_action" value="Valider_demande" /><input type="submit" value="Valider et actualiser l'affichage." /><label id="ajax_msg1">&nbsp;</label>
		</p>
	</div>
</form>

<?php
/**
 * @version $Id: fonction_requetes_formulaires_select.php 8 2009-10-30 20:56:02Z thomas $
 ...
 * 		function matieres_communes()
 * 		function matieres_professeur()
 * 		function matieres_eleve()
 * 		function niveaux_etabl()
 * 		function niveaux_eleve()
 * 		function groupes_etabl()
 * 		function groupes_professeur()
 * 		function besoins_professeur()
 * 		function classes_etabl()
 * 		function classes_prof_principal()
 * 		function professeurs_etabl()
 * 		function eleves_regroupement($groupe_type,$groupe_id)
 * 		function structures_sacoche()
 * 		function structures_partage()
...
function load_cookie_select()
{
	$filename = './__tmp/cookie/etabl'.$_SESSION['STRUCTURE_ID'].'_user'.$_SESSION['USER_ID'].'.txt';
	if(is_file($filename))
	{
 ...
 function save_cookie_select()
{
	...
	file_put_contents('./__tmp/cookie/etabl'.$_SESSION['STRUCTURE_ID'].'_user'.$_SESSION['USER_ID'].'.txt',serialize($tab_cookie));
	/*
 ...
 * [./pages_administrateur/professeur_matiere.php]
 * 
 * @param void
 * @return array|string
 */

function matieres_etabl()
{
 ...
 * [./pages_professeur/recherche_generale.php] [./pages_professeur/recherche_precise.php]
 * 
 * @param void
 * @return array|string
 */
...
function matieres_communes()
{
	if($_SESSION['MATIERES'])
	{
		$DB_SQL = 'SELECT livret_matiere_id AS valeur, livret_matiere_nom AS texte FROM livret_matiere ';
		$DB_SQL.= 'WHERE livret_matiere_id IN('.$_SESSION['MATIERES'].') ';
		$DB_SQL.= 'ORDER BY livret_matiere_nom ASC';
 ...
 * [./pages_professeur/bilan_niveau.php] [./pages_professeur/bilan_periode.php] [./pages_professeur/grille_niveau.php]
 * 
 * @param void
 * @return array|string
 */
 ...
 * [./pages_eleve/bilan_periode.php] [./pages_eleve/grille_niveau.php]
 * 
 * @param void
 * @return array|string
 */
...
function matieres_groupe($groupe_id)
{
 ...
 * [./pages_professeur/bilan_niveau.php] [./pages_professeur/grille_niveau.php] [./pages_professeur/recherche_generale.php]
 * 
 * @param void
 * @return array|string
 */
 ...
 * [./pages_professeur/releve_socle.php]
 * 
 * @param void
 * @return array|string
 */

function paliers_etabl()
{
	if($_SESSION['PALIERS'])
	{
	...
	{
		return 'Aucun paliers du socle commun n\'est rattaché à l\'établissement !';
	}
}
...
function niveaux_eleve()
{
	if($_SESSION['NIVEAUX'])
	{
		...
		$DB_SQL.= 'WHERE livret_structure_id=:structure_id AND livret_niveau_id IN('.$_SESSION['NIVEAUX'].') ';
		$DB_SQL.= 'GROUP BY livret_niveau_id ';
		$DB_SQL.= 'ORDER BY livret_niveau_ordre ASC';
		$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID']);
		$DB_TAB = DB::queryTab(SACOCHE_BD_NAME , $DB_SQL , $DB_VAR);
		// Tester la présence de la classe parmi la liste des id de groupes
		$search_valeur = ','.$_SESSION['ELEVE_CLASSE_ID'].',';
		foreach($DB_TAB as $key => $DB_ROW)
		{
 ...
 * [./pages_administrateur/eleve_classe.php] [./pages_administrateur/eleve_groupe.php]
 *
 * @param void
 * @return array|string
 */

function regroupements_etabl()
{
 ...
 * [./pages_administrateur/eleve_groupe.php] [./pages_administrateur/professeur_groupe.php]
 *
 * @param void
 * @return array|string
 */
 ...
 * optgroup sert à pouvoir regrouper les options
 * [./pages_professeur/bilan_periode.php] [./pages_professeur/grille_niveau.php] [./pages_professeur/bilan_niveau.php]
 *
 * @param void
 * @return array|string
 */
 ...
 * [./pages_professeur/eleve_groupe.php]
 * 
 * @param void
 * @return array|string
 */
 ...
 * [./pages_administrateur/eleve_classe.php] [./pages_administrateur/professeur_classe.php] [./pages_administrateur/periode_classe.php]
 *
 * @param void
 * @return array|string
 */
...
function classes_groupes_etabl()
{
	$GLOBALS['tab_select_option_first'] = array(0,'Fiche générique','');
	$DB_SQL = 'SELECT livret_groupe_id AS valeur, livret_groupe_nom AS texte, livret_groupe_type AS optgroup FROM livret_groupe ';
	$DB_SQL.= 'LEFT JOIN livret_niveau USING (livret_niveau_id) ';
 ...
 * [./pages_professeur/bilan_pp_indiv.php]
 * 
 * @param void
 * @return array|string
 */
...
function classes_prof_principal()
{
	...
	$DB_SQL.= 'ORDER BY livret_niveau_ordre ASC, livret_groupe_nom ASC';
	$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':user_id'=>$_SESSION['USER_ID'],':type1'=>'classe',':pp'=>1);
	$DB_TAB = DB::queryTab(SACOCHE_BD_NAME , $DB_SQL , $DB_VAR);
 ...
 * [./pages_administrateur/periode_classe-groupe.php]
 *
 * @param void
 * @return array|string
 */

function periodes_etabl()
{
 ...
 * [./pages_administrateur/_maj_select_professeurs.php] pour [./pages_administrateur/imp-exp_del-professeur.js] [./pages_administrateur/imp-exp_loginmdp-professeur.js]
 * [./pages_administrateur/professeur_classe.php] [./pages_administrateur/professeur_matiere.php]
 * 
 * @param void
 * @return array|string
 */
 ...
 * optgroup sert à pouvoir regrouper les options
 * [./pages_administrateur/fichier_loginmdp-professeur-directeur.php]
 * 
 * @param int $statut statut des utilisateurs (1 pour actif, 0 pour inactif)
 * @return array|string
 */

function professeurs_directeurs_etabl($statut)
{
	...
	$DB_SQL.= 'WHERE livret_structure_id=:structure_id AND livret_user_profil IN(:profil1,:profil2) AND livret_user_statut=:statut ';
	$DB_SQL.= 'ORDER BY livret_user_profil DESC, livret_user_nom ASC, livret_user_prenom ASC';
	$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil1'=>'professeur',':profil2'=>'directeur',':statut'=>$statut);
	$DB_TAB = DB::queryTab(SACOCHE_BD_NAME , $DB_SQL , $DB_VAR);
	$GLOBALS['tab_select_optgroup'] = array('directeur'=>'Directeurs','professeur'=>'Professeurs');
	$mot = ($statut) ? 'enregistré' : 'désactivé' ;
 ...
 * [./pages_administrateur/_maj_select_eleves.php] pour [./pages_administrateur/eleve_classe.js] [./pages_administrateur/eleve_groupe.js] [./pages_administrateur/imp-exp_del-eleve.js] [./pages_administrateur/imp-exp_loginmdp-eleve.js]
 * [./pages_professeur/_maj_select_eleves.php] pour [./pages_administrateur/bilan_periode.js] [./pages_administrateur/bilan_pp_indiv.js]
 * 
...
function eleves_regroupement($groupe_type,$groupe_id,$statut)
{
	$DB_SQL = 'SELECT livret_user_id AS valeur, CONCAT(livret_user_nom," ",livret_user_prenom) AS texte FROM livret_user ';
	switch ($groupe_type)
	{
		case 'sdf' :	// On veut les élèves non affectés dans une classe
			...
			$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil'=>'eleve',':statut'=>$statut,':classe'=>0);
			break;
		case 'all' :	// On veut tous les élèves de l'établissement
			$DB_SQL.= 'WHERE livret_structure_id=:structure_id AND livret_user_profil=:profil AND livret_user_statut=:statut ';
			$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil'=>'eleve',':statut'=>$statut);
			break;
		case 'niveau' :	// On veut tous les élèves d'un niveau
			...
			$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil'=>'eleve',':statut'=>$statut,':niveau'=>$groupe_id);
			break;
		case 'classe' :	// On veut tous les élèves d'une classe (on utilise "livret_eleve_classe_id" de "livret_user")
			$DB_SQL.= 'WHERE livret_structure_id=:structure_id AND livret_user_profil=:profil AND livret_user_statut=:statut AND livret_eleve_classe_id=:classe ';
			$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil'=>'eleve',':statut'=>$statut,':classe'=>$groupe_id);
			break;
		...
		case 'besoin' :	// On veut tous les élèves d'un groupe de besoin (on utilise la jointure de "livret_jointure_user_groupe")
			...
			$DB_VAR = array(':structure_id'=>$_SESSION['STRUCTURE_ID'],':profil'=>'eleve',':statut'=>$statut,':groupe'=>$groupe_id);
			break;
	}
	$DB_SQL.= 'ORDER BY livret_user_nom ASC, livret_user_prenom ASC';
	$DB_TAB = DB::queryTab(SACOCHE_BD_NAME , $DB_SQL , $DB_VAR);
 ...
 * le continent sert à pouvoir regrouper les options
 * [./pages_professeur/recherche_precise.php]
 * 
 * @param void
 * @return array|string
 */
...
function structures_partage()
{
	...
	$DB_SQL.= 'WHERE livret_structure_id!='.ID_DEMO.' AND livret_niveau_id IN('.$_SESSION['NIVEAUX'].') AND livret_referentiel_partage=:partage ';

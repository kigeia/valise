...
$select_niveau      = afficher_select(DB_OPT_niveaux_eleve($_SESSION['NIVEAUX'],$_SESSION['PALIERS'],$_SESSION['ELEVE_CLASSE_ID']) , $select_nom='f_niveau'      , $option_first='oui' , $selection='val'                        , $optgroup='non');

...
if($_SESSION['USER_PROFIL']=='directeur')
{
	...
	$check_bilan_pv        = ' checked="checked"';
}
...
if($_SESSION['USER_PROFIL']=='eleve')
{
	...
	$check_bilan_ms        = (mb_substr_count($_SESSION['ELEVE_OPTIONS'],'ms')) ? ' checked="checked"' : '';
	$check_bilan_pv        = (mb_substr_count($_SESSION['ELEVE_OPTIONS'],'pv')) ? ' checked="checked"' : '';
}

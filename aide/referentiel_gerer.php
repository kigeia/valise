...
<ul class="puce">
	...
	<li>Concernant le nombre d'évaluations prises en compte, le nombre maximal dépend du mode de calcul, et le nombre minimal peut être paramétré (jusqu'à se restreindre à la dernière évaluation).</li>
</ul>

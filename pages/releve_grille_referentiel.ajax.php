...
if( !$matiere_id || !$niveau_id || !$matiere_nom || !$niveau_nom || !$remplissage || !$colonne_bilan || !$orientation || !$couleur || !$legende || !$marge_min || !$cases_nb || !$cases_largeur )
{
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
// Récupération de la liste des résultats (si pas grille générique et si demandé ou si besoin pour colonne bilan ou si besoin car profil élève donc panier afin de solliciter une évaluation)
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-

if( count($tab_eleve_id) && ( ($remplissage=='plein') || ($colonne_bilan=='oui') || ($_SESSION['USER_PROFIL']=='eleve') ) )
{
...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
// Calcul des états d'acquisition (si besoin).
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
...
foreach($tab_eleve as $tab)
{
	...
	if(count($tab_domaine))
	{
		foreach($tab_domaine as $domaine_id => $tab)
		{
			...
			$releve_HTML .= '<tr><th colspan="2" class="domaine">'.html($domaine_nom).'</th><th colspan="'.$colspan.'" class="nu"></th></tr>'."\r\n";
			...
			if(isset($tab_theme[$domaine_id]))
			{
				foreach($tab_theme[$domaine_id] as $theme_id => $tab)
				{
					...
					$releve_HTML .= '<tr><th>'.$theme_ref.'</th><th>'.html($theme_nom).'</th><th colspan="'.$colspan.'" class="nu"></th></tr>'."\r\n";
					...
					if(isset($tab_item[$theme_id]))
					{
						foreach($tab_item[$theme_id] as $item_id => $tab)
						{
							...
							$releve_HTML .= '<tr><td>'.$item_ref.'</td><td>'.$texte_coef.$texte_socle.$texte_lien_avant.html($item_nom).$texte_lien_apres.$texte_demande_eval.'</td>';
							...
							{
								$releve_HTML .= affich_score_html($score,'score');

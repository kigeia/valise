...
if( $detail && $palier_id && $palier_nom && $remplissage )
{
	...
	$tab_competence = array();	// [competence_id] => array(competence_ref,competence_nom);
	...
	if($test_affichage_scores)
	{
		...
		foreach($DB_TAB as $key => $DB_ROW)
		{
			...
			$tab_competence[$DB_ROW['competence_id']] = array('competence_ref'=>$DB_ROW['competence_ref'],'competence_nom'=>$DB_ROW['competence_nom']);
		}
	}

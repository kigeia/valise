...
$select_parents                = afficher_select(DB_STRUCTURE_COMMUN::DB_OPT_parents_etabl($statut=0)                , $select_nom=false , $option_first='non' , $selection=false , $optgroup='non');
$select_professeurs_directeurs = afficher_select(DB_STRUCTURE_COMMUN::DB_OPT_professeurs_directeurs_etabl($statut=0) , $select_nom=false , $option_first='non' , $selection=false , $optgroup='oui');
?>

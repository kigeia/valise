...
$select_periodes        = afficher_select(DB_STRUCTURE_COMMUN::DB_OPT_periodes_etabl($alerte=TRUE) , $select_nom=false , $option_first='non' , $selection=false , $optgroup='non');
$select_classes_groupes = afficher_select(DB_STRUCTURE_COMMUN::DB_OPT_classes_groupes_etabl()      , $select_nom=false , $option_first='non' , $selection=false , $optgroup='oui');
?>

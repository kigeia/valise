<?php
/**
 * @version $Id: intro-pourquoi-nom.php 8 2009-10-30 20:56:02Z thomas $
...
$TITRE = "Pourquoi le nom SACoche ?";
?>

<ul class="puce">
	<li><em>SACoche</em> parce que "SAC" signifie "Suivi d'Acquisition de Compétences".</li>
	<li><em>SACoche</em> avec "oche" pour compléter l'acronyme en référence à d'autres projet de Sésamath : Mathenpoche, Tracenpoche, Instrumenpoche, Casenpoche.</li>
	<li><em>SACoche</em> parce qu'un professeur qui évalue par compétences, "ça coche" des compétences.</li>
	<li><em>SACoche</em> pour la sacoche du professeur...</li>
</ul>
...
<ul class="puce">
	...
	<li><span class="manuel">DOC : Pourquoi le nom <em>SACoche</em> ?</span></li>

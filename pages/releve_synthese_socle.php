...
$TITRE = "Synthèse des validations du socle";
$VERSION_JS_FILE += 0;
?>
...
<ul class="puce">
	<li><span class="manuel"><a class="pop_up" href="<?php echo SERVEUR_DOCUMENTAIRE ?>?fichier=releves_bilans__synthese_socle">DOC : Synthèse des validations du socle.</a></span></li>
</ul>

...
<ul class="puce">
	...
	<li><span class="astuce">Pour mettre à jour un référentiel modifié sur le serveur communautaire, utiliser la page "<a href="./index.php?page=referentiel&amp;section=global">gérer les référentiels</a>".</span></li>

...
$select_groupe       = afficher_select($tab_classes_groupes    , $select_nom='f_groupe'      , $option_first='oui' , $selection=false                        , $optgroup='oui');
...
if(is_array($tab_classes_groupes))
{
	$tab_id_classe_groupe = array();
	foreach($tab_classes_groupes as $tab_groupe_infos)
	{
